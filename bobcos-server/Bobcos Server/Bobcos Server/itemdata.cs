...
namespace Bobcos_Server
{
    class itemdata
    {
        ...
        public static void Initiliaze()
        {
            ...
            items[5] = new item { itemname = "White door", avoidAntiNoclip = true, itemid = 5, itemtype = "BLOCK", description = "No description.", mingem = 0, maxgem = 100, blockhealth = 3, istradable = false };
